module.exports = {
  ...
  homepage: {
    meta: {
      title: 'Help A Seller - The complete information about selling Online',
      description:
        'Build your online shop/product using information on this Website. We are information platform to help sellers to sell in online competitive e-commerce.'
    },
    welcome: {
      title: "Online Selling is hard {br} Let's solve it together",
      description:
        'Build your online shop/product using information on this Website. We are information platform to help sellers to sell in online competitive e-commerce.',
      openSource: 'open source',
      get_started: 'get started',
      get_updates: 'Get Help A Seller updates to your inbox each month',
      video:
        'Video produced by Help a Seller, download their free {cheatSheet}',
      cheatSheet: 'Selling Online Cheat Sheet.'
    },
    why: {
      title: 'Why Online Selling is hard',
      try_nuxtjs_online: 'Read More',
      enjoyable: {
        title: 'Enjoyable',
        description:

  ...
  data() {
    return {
      links: {
        ...
        follow: [
          { key: 'Facebook', href: 'https://www.facebook.com/HelpASeller' },
          { key: 'Twitter', href: 'https://twitter.com/helpasellerhq' },
        ],
        support: [
          { key: 'Help A Seller\'s Support', to: this.localePath('/support') }
        ]
      }
    }
  }
